...
Select a feeder to generate a communications map on top of. See here for information on selecting a feeder and using the grid editing tool : https://github.com/dpinney/omf/wiki/Tools-~-gridEdit
